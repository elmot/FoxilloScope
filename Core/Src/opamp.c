...
void HAL_OPAMP_MspInit(OPAMP_HandleTypeDef* opampHandle)
{
  ...
  /* USER CODE END OPAMP3_MspInit 0 */
    ...
    PB2     ------> OPAMP3_VINM0
    */
    GPIO_InitStruct.Pin = SHIFTED_B_Pin|AMPLIFIED_B_Pin;
  ...
  /* USER CODE END OPAMP4_MspInit 0 */
    ...
    PB12     ------> OPAMP4_VOUT
    */
    GPIO_InitStruct.Pin = AMPLIFIED_A_Pin|SHIFTED_AB12_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
  ...
  /* USER CODE END OPAMP6_MspInit 0 */
    ...
    PB13     ------> OPAMP6_VINP
    */
    GPIO_InitStruct.Pin = AMPLIFIED_BB11_Pin|INPUT_B_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
...
void HAL_OPAMP_MspDeInit(OPAMP_HandleTypeDef* opampHandle)
{
  ...
  /* USER CODE END OPAMP3_MspDeInit 0 */
    ...
    PB2     ------> OPAMP3_VINM0
    */
    HAL_GPIO_DeInit(GPIOB, SHIFTED_B_Pin|AMPLIFIED_B_Pin);
  ...
  /* USER CODE END OPAMP4_MspDeInit 0 */
    ...
    PB12     ------> OPAMP4_VOUT
    */
    HAL_GPIO_DeInit(GPIOB, AMPLIFIED_A_Pin|SHIFTED_AB12_Pin);
  ...
  /* USER CODE END OPAMP6_MspDeInit 0 */
    ...
    PB13     ------> OPAMP6_VINP
    */
    HAL_GPIO_DeInit(GPIOB, AMPLIFIED_BB11_Pin|INPUT_B_Pin);
