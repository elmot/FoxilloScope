...
#define INPUT_A_Pin GPIO_PIN_3
#define INPUT_A_GPIO_Port GPIOC
...
#define INPUT_B_Pin GPIO_PIN_7
#define INPUT_B_GPIO_Port GPIOA
#define SHIFTED_B_Pin GPIO_PIN_1
#define SHIFTED_B_GPIO_Port GPIOB
#define AMPLIFIED_BB2_Pin GPIO_PIN_2
