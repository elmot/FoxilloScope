...
|:------------|:---------------------------------------------|:-------------------------------------------------------------------|:-----|:------------------------------------------------|
|             | **Test Signal**                              |                                                                    |      |                                                 |
| DAC1        | DAC1_OUT1                                    | *TODO* remove - test signal                                        | PA4  |                                                 |
...
| DAC4        | *(int)* DAC4_OUT1                            | Trigger level, internally connected                                | -    |                                                 |
|             | **Channel A**                                |                                                                    |      |                                                 |
...
|             | **Channel B**                                |                                                                    |      |                                                 |
| OPAMP2      | Follower                                     | *CH2 Input* (connect to **PA4**)                                   | PA7  | OPAMP2_VINP                                     |           
